...
/**
 * Awareness/presence types and helpers for Prello
 *
...
export interface PrelloPresence {
	user: {
		name: string
		color: string
	}
 ...
 */
export function getRemotePresenceStates(awareness: Awareness): Map<number, PrelloPresence> {
