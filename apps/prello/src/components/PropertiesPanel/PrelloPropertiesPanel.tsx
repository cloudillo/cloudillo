...
import type { YPrelloDocument, ObjectId, ViewId, ContainerId } from '../../crdt'
...
export interface PrelloPropertiesPanelProps {
	doc: YPrelloDocument
	yDoc: Y.Doc
...
export function PrelloPropertiesPanel({
	doc,
	yDoc,
	selectedIds,
	onSelectObject,
