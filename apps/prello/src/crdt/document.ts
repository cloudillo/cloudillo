...
/**
 * Get or create the Prello document structure from a Y.Doc
 ...
 */
function initializeDocument(yDoc: Y.Doc, doc: YPrelloDocument): void {
	yDoc.transact(() => {
 ...
 */
function addDefaultStyles(doc: YPrelloDocument): void {
	// Default shape style
 ...
 */
export function getDocumentMeta(doc: YPrelloDocument): {
	name: string
