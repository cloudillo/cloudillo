...
import type { YPrelloDocument, ChildRef, StoredObject } from './stored-types'
import type { ObjectId, ContainerId, RichTextId } from './ids'
import { generateObjectId, generateRichTextId } from './ids'
import type { PrelloObject } from './runtime-types'
...
export function createObject(
	...
	const base: Partial<PrelloObject> = {
		id: objectId,
		type,
		x,
		y,
...
export function updateObject(
	...
	const compacted = compactObject(updated as PrelloObject)
