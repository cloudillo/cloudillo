...
export interface PrelloObjectBase {
	id: ObjectId
	type: ObjectType
...
// Rect object
export interface RectObject extends PrelloObjectBase {
	type: 'rect'
	cornerRadius?: number | [number, number, number, number]
}

// Ellipse object
export interface EllipseObject extends PrelloObjectBase {
	type: 'ellipse'
}

// Line object
export interface LineObject extends PrelloObjectBase {
	type: 'line'
...
// Path object
export interface PathObject extends PrelloObjectBase {
	type: 'path'
	pathData: string
}

// Polygon object
export interface PolygonObject extends PrelloObjectBase {
	type: 'polygon'
...
export interface TextObject extends PrelloObjectBase {
	type: 'text'
	text: string
}

// Textbox object (rich text)
export interface TextboxObject extends PrelloObjectBase {
	type: 'textbox'
...
// Image object
export interface ImageObject extends PrelloObjectBase {
	type: 'image'
	src: string
	alt?: string
...
// Embed object
export interface EmbedObject extends PrelloObjectBase {
	type: 'embed'
...
// Connector object
export interface ConnectorObject extends PrelloObjectBase {
	type: 'connector'
