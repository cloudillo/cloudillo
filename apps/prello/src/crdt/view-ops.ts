...
import type { YPrelloDocument, StoredView } from './stored-types'
 ...
 * Get view count
 */
export function getViewCount(doc: YPrelloDocument): number {
 ...
 * Get first view
 */
export function getFirstView(doc: YPrelloDocument): ViewId | null {
	const viewIds = doc.vo.toArray()
 ...
 * Get last view
 */
export function getLastView(doc: YPrelloDocument): ViewId | null {
	const viewIds = doc.vo.toArray()
