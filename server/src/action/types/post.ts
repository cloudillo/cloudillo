...
const tPost = T.struct({
	iss: T.string,
	k: T.string,
	t: T.literal('POST'),
	st: T.optional(T.literal('TEXT', 'IMG', 'VID', 'DEL')),
	c: T.string,
	p: T.undefinedValue,
...
async function handlePost({ tnId, idTag }: ActionContext, actionId: string, action: Action) {
