...
function CommunityListItem({ community, isActive, onSwitch, onToggleFavorite }: CommunityListItemProps) {
  return (
    <div
      ...
      >
        ...
        <div className="c-sidebar-footer">
          <button
            ...
            onClick={() => navigate(`/communities/${activeContext?.idTag || auth?.idTag}`)}
