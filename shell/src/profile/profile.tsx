			...
			<Fcd.Content>
				<div className="c-panel p-0 pos-relative d-flex flex-column">
					<div className="c-profile-header pos-relative w-100" style={{ minHeight: '160px' }}>
						{ profile.coverPic &&
							<img className="c-profile-cover w-100" src={`https://cl-o.${profile.idTag}/api/file/${profile.coverPic}?variant=vis.hd`}/>
						}
						{ own && <>
						...
						<div className="c-profile-pic-container">
							{ profile.profilePic
								? <img className="c-profile-pic" src={`https://cl-o.${profile.idTag}/api/file/${profile.profilePic}?variant=vis.sd`} alt="Profile picture"/>
