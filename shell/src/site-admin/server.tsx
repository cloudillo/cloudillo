...
export function ServerSettings() {
	...
	return <>
		<div className="c-panel">
			...
			<p className="c-hint mb-4">{t('Controls whether new users can register on this instance')}</p>
		</div>
		...
		<div className="c-panel">
			...
			<p className="c-hint mb-4">{t('Allow this instance to communicate and share data with other Cloudillo instances')}</p>
		</div>
	</>
}
