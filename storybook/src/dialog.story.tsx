		...
		<>
			<Story
				...
				props={[
					...
					{
						name: 'tell',
						type: '(title: string, descr: string, className?: string) => Promise<void>',
						descr: 'Show info dialog'
					},
					{
						name: 'confirm',
						type: '(title: string, descr: string, className?: string) => Promise<boolean>',
						descr: 'Show OK/Cancel dialog'
					},
					{
						name: 'ask',
						type: '(title: string, descr: string, className?: string) => Promise<boolean>',
					...
					{
						name: 'askText',
						type: '(title: string, descr: string, opts?: {...}) => Promise<string | undefined>',
