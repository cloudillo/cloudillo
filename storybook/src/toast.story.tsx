			...
			props={[
				{
					...
					descr: 'ToastContainer: position on screen'
				},
				{
					name: 'variant',
					type: '"success" | "error" | "warning" | "info"',
					descr: 'Toast: color variant'
				},
...
toast.toasts // Array of current toasts`}</pre>
			...
			<Variant name="Toast Components">
				<div className="c-panel p-3">
					<ul>
						<li>
							<code>ToastContainer</code> - Positioned container for toasts
						</li>
						<li>
							<code>Toast</code> - Individual toast wrapper
						</li>
						<li>
							<code>ToastIcon</code> - Icon area
						</li>
						<li>
							<code>ToastContent</code> - Content wrapper
						</li>
						<li>
							<code>ToastTitle</code> - Toast title
						</li>
						<li>
							<code>ToastMessage</code> - Toast message
						</li>
						<li>
							<code>ToastActions</code> - Action buttons area
						</li>
						<li>
							<code>ToastClose</code> - Close button
						</li>
						<li>
							<code>ToastProgress</code> - Auto-dismiss progress bar
						</li>
					</ul>
				</div>
			</Variant>
